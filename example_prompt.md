...
**FOR COMPLEX WORK**: Call the `init_conversation(name)` MCP-Tool which **automatically provides full startup context** including user info, recent memories, relations, tasks, and todos. This should be your first action in any new technical session.
...
- ✅ Intelligent, context-aware assistance tailored to **User**.
